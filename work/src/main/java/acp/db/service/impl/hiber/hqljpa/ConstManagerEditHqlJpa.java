...
public class ConstManagerEditHqlJpa extends ManagerBaseHiber implements IConstManagerEdit {
  private static Logger logger = LoggerFactory.getLogger(ConstManagerEditHqlJpa.class);
  ...
  public boolean delete(Long objId) {
    ...
    try {
      // ---------------------------------------------------
//      entityManager.remove(entityManager.getReference(ConstClass.class, objId));
//      ConstClass objClass = entityManager.find(ConstClass.class, objId);
