...
public class ConstManagerEditSqlJpa extends ManagerBaseHiber implements IConstManagerEdit {
  private static Logger logger = LoggerFactory.getLogger(ConstManagerEditSqlJpa.class);
