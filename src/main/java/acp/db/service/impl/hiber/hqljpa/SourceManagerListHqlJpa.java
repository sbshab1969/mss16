...
public class SourceManagerListHqlJpa extends ManagerListHiber<SourceDto> {
  private static Logger logger = LoggerFactory.getLogger(SourceManagerListHqlJpa.class);
  ...
  public SourceManagerListHqlJpa() {
