...
public class VarManagerEditHqlJpa extends ManagerBaseHiber implements IVarManagerEdit {
  private static Logger logger = LoggerFactory.getLogger(VarManagerEditHqlJpa.class);
...
//    sbQuery.append("select v ");  // !!!!
    sbQuery.append("from VarClass v");
