...
public class FileLoadManagerListHqlJpa extends ManagerListHiber<FileLoadDto> {
  private static Logger logger = LoggerFactory.getLogger(FileLoadManagerListHqlJpa.class);
  ...
  public FileLoadManagerListHqlJpa() {
