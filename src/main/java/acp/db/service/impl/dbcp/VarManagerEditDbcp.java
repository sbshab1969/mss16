...
public class VarManagerEditDbcp extends ManagerBaseDbcp implements IVarManagerEdit {
  private static Logger logger = LoggerFactory.getLogger(VarManagerEditDbcp.class);
