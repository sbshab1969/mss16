...
public class ConstManagerEditDbcp extends ManagerBaseDbcp implements IConstManagerEdit {
  private static Logger logger = LoggerFactory.getLogger(ConstManagerEditDbcp.class);
