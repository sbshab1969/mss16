...
import acp.db.service.impl.dbcp.ConstManagerEditDbcp;
import acp.db.service.impl.dbcp.ConstManagerListDbcp;
import acp.db.service.impl.dbutil.ConstManagerEditDbutil;
import acp.db.service.impl.dbutil.ConstManagerListDbutil;
...
public class ConstManagerFactory {
  ...
  public static IManagerList<ConstDto> getManagerList() {
    ...
    case DBCP:
      return new ConstManagerListDbcp();
    case DBUTIL:
      return new ConstManagerListDbutil();
    case HB_HQL:
  ...
  public static IConstManagerEdit getManagerEdit() {
    ...
    case DBCP:
      return new ConstManagerEditDbcp();
    case DBUTIL:
      return new ConstManagerEditDbutil();
    case HB_HQL:
