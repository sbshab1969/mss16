...
import acp.db.service.impl.dbcp.VarManagerEditDbcp;
import acp.db.service.impl.dbcp.VarManagerListDbcp;
import acp.db.service.impl.dbutil.VarManagerEditDbutil;
import acp.db.service.impl.dbutil.VarManagerListDbutil;
...
public class VarManagerFactory {
  ...
  public static IManagerList<VarDto> getManagerList() {
    ...
    case DBCP:
      return new VarManagerListDbcp();
    case DBUTIL:
      return new VarManagerListDbutil();
    case HB_HQL:
  ...
  public static IVarManagerEdit getManagerEdit() {
    ...
    case DBCP:
      return new VarManagerEditDbcp();
    case DBUTIL:
      return new VarManagerEditDbutil();
    case HB_HQL:
